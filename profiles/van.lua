...
function setup()
  return {
    ...
    -- NISSAN E-NV200
    vehicle_height = 1.85, -- in meters
    vehicle_width = 1.75, -- in meters, ways with narrow tag are considered narrower than 2.2m

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 4.6, -- in meters,
    vehicle_weight = 2500, -- in kilograms
